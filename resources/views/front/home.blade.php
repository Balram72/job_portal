                              ...
                              <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ \Illuminate\Support\Str::words(strip_tags($featuredJob->description), $words=5,'...') }}</p>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ \Illuminate\Support\Str::words(strip_tags($latesJob->description), $words=5,'...') }}</p>
                                            <div class="bg-light p-3 border">
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail', $latesJob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
