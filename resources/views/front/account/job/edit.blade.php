                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" placeholder="Job Title" value="{{$job->title}}" id="title" name="title"
                                        class="form-control">
                                    <span></span>
                                </div>
                                <div class="col-md-6  mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input type="number" min="1" value="{{$job->vacancy}}" placeholder="Vacancy" id="vacancy" name="vacancy"
                                        class="form-control">
                                </div>
                                <span></span>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text"  value="{{$job->company_name}}" placeholder="Company Name" id="company_name" name="company_name"
                                        class="form-control">
                                    <span></span>
                                </div>
